...
if __name__ == "__main__":
    robot_chessboard_pts = np.load("calib/robot_pts.npy", allow_pickle=True)
    cam_chessboard_pts = np.load("calib/cam_pts.npy", allow_pickle=True)
    print(robot_chessboard_pts.shape)
    print(cam_chessboard_pts.shape)
    # print(robot_chessboard_pts.shape, cam_chessboard_pts.shape)
