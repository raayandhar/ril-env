...
class SerialPort(Port):
    def __init__(
        self,
        port,
        baud=XCONF.SerialConf.SERIAL_BAUD,
        rxque_max=XCONF.SerialConf.UXBUS_RXQUE_MAX,
        protocol=XCONF.SerialConf.UX2_HEX_PROTOCOL,
    ):
        ...
        try:
            ...
            logger.info(
                "{} connect {}:{} failed, {}".format(self.port_type, port, baud, e)
            )
            self._connected = False
